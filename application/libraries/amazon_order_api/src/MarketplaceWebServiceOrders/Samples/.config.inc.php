 ...
 * http://aws.amazon.com
 ***********************************************************************/
define('AWS_ACCESS_KEY_ID', '< YOUR AWS_ACCESS_KEY_ID >');
define('AWS_SECRET_ACCESS_KEY', '< YOUR AWS_SECRET_ACCESS_KEY >');
 ...
 ***********************************************************************/
define('APPLICATION_NAME', 'Pratik');
 ...
 * marketplace ID.
 ***********************************************************************/
define('MERCHANT_ID', '< YOUR MERCHANT_ID >');
define('MARKETPLACE_ID', '< YOUR MARKETPLACE_ID >');
